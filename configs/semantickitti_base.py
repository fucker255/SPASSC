...
train_pipeline = [
    ...
    dict(type='CollectData', keys=['img_inputs', 'gt_occ','gt_occ_2','gt_semantics'], 
            meta_keys=['pc_range', 'occ_size', 'raw_img','frame_id', 'stereo_depth', 'sequence', 'img_shape', 'gt_depths']),
]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        cls_weights=[
            1.0, 3.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 5.0, 1.0, 2.0, 2.0, 3.0, 3.0, 3.0, 2.0, 5.0, 2.0, 5.0, 5.0
            ],
        norm_cfg=dict(type='GN', num_groups=32, requires_grad=True),
...
"""Training params."""
learning_rate=3e-4
training_steps=10500//batch_size #一个epoch5000步，多卡会除以卡数 即 epoch25*5000/4=31250
