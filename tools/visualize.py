...
sequence = '08'
data_root = '/tmp/dataset/semantickitti'
pred_root = '/tmp/pre-model/?/pred/sequnences'
write_root = '/tmp/model/visualization'
gt_root = '/tmp/dataset/semantickitti/labels'
calib_file = os.path.join(data_root,'sequences', sequence, 'calib.txt')
calib_all = {}
